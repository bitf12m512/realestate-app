...
Widget TextFieldWithOutPrefix(BuildContext context,String prefixText,String hinttext,bool enable,TextEditingController controller, TextInputType keyboardType,int limit){
  return TextFormField(
    ...
    decoration: InputDecoration(
      ...
      prefixStyle:TextStyle(color: Colors.black.withOpacity(0.8), fontSize: 14),
      contentPadding:
