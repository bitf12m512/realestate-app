                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFieldWithOutPrefix(context, prefixText,
                              "phoneNumber".tr(), true, phone, TextInputType.phone, 14),
                          SizedBox(
                            height: 10,
                          ),
                          Row(
                            children: [
                              ...
                              Align(
                                ...
                                child: CustomText(
                                  text: "I Agree to terms & conditions".tr(),
                          ...
                          bigButton(context, "Register".tr(), () {
                            if (_formKey.currentState.validate()) {
                              if (agree == true) {
                                handelOTPSignup();
                              } else {
                                Toast.show(
                                    "Make Sure You agree to our Terms and Conditions.".tr(),
                                    context,
                                    duration: 4,
                                    gravity: Toast.TOP);
                              }
  ...
  Future<void> handelOTPSignup() async {
    ...
    try {
      await FirebaseAuth.instance.verifyPhoneNumber(
          ...
          verificationFailed: (FirebaseAuthException authException) {
            ...
            if (authException.toString().contains(
              ...
              Toast.show(
                  "We have blocked all requests from this device is blocked due to unusual activity. Try again later. ".tr(),
                  context,
                  duration: 4,
                  gravity: Toast.TOP);
            } else {
              Toast.show(
                  "Please enter a valid contact number. Follow the +123 34323454 format.".tr(),
                  context,
                  duration: 4,
                  gravity: Toast.TOP);
            }
      ...
      if (e.code == "user-not-found".toLowerCase())
        ...
        Toast.show('emailAlready'.tr(), context,
            duration: 4, gravity: Toast.TOP);
      else if (e.code == "wrong-password".toLowerCase())
        Toast.show('enterCorrectPass'.tr(), context,
            duration: 4, gravity: Toast.TOP);
      else
        Toast.show('errorSigin'.tr(), context,
            duration: 4, gravity: Toast.TOP);
    }
  }
  Widget codePage(){
        ...
        if(codepage==true){
          ...
          await FirebaseDatabase.instance
            ...
            if (dataSnapshot.value != null) {
              Toast.show("An account already exist on this number. Try Login :)".tr(),
                  context, duration: 4, gravity: Toast.TOP);
              ...
              Navigator.of(context).pop();
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (_) => BottomNavPage(user.user.uid)));
              // }
              // Navigator.of(context).pop();
              // if (appUser.active == false) {
              //   // Future.delayed(Duration(seconds: 2)).then((val) {
              //   Toast.show("Your account have been blocked".tr(), context,
              //       duration: 4, gravity: Toast.TOP);
              //   Navigator.of(context).pushReplacement(
