...
class _SignInPageState extends State<SignInPage> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFieldBox(context, Icons.call, "phoneNumber".tr(), true, phone,
                        ...
                        Padding(
                          ...
                          child: bigButton(context, "Sign in".tr(), () {
  ...
  Future<void> handelCode(String code) async {
    ...
    try {
      ...
      if (code == "0000") {
        Navigator.of(context).pop();
        Toast.show('Connection timed out. Try again.'.tr(), context,
            duration: 4, gravity: Toast.TOP);
      }
      else {
        var user = await FirebaseAuth.instance
          ...
          if (error.toString().contains(
            ...
            Navigator.of(context).pop();
            Toast.show(
                "The sms verification code is invalid. Send it again.".tr(), context,
                duration: 4, gravity: Toast.TOP);
          }
        });
       if(codepage==true){
