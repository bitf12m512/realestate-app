...
class _EditPropertyPageState extends State<EditPropertyPage> {
                              ...
                              onTap: () {
                                imageSelectionOption(context, () async {
                                  ...
                                  if (res.success) {
                                    ...
                                    Navigator.of(context).pop();
                                    showAlertDialog(context, "Please wait...");
                                    for (int i = 0; i < imagesur.length; i++) {
                                      String imgu =
                                          await uploadimage(imagesur[i]);
                                      ImageUrls.add(imgu);
                                      // setState(() {
                                      //
                                      // });
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            dropDownItem(context, "Category", category,
                            ...
                            dropDownItem(
                                ...
                                district,
                                "Choose District",
                                governorate.toLowerCase().contains("city")
                                    ? city
                                    : governorate
                                            .toLowerCase()
                                            .contains("Hawalli")
                            ...
                            dropDownItem(context, "Position of RealEstate",
                                position, "Choose Position", positions, (val) {
                              setState(() {
                                position = val;
                              });
                            }),
                            ...
                            saveButton(context, "Update", () {
                              if (ImageUrls.length == 0) {
                                Toast.show(
                                    "Please add some images of your Property.",
                                    context,
                                    duration: 4,
                                    gravity: Toast.TOP);
                              } else {
                                if (name.text == "") {
                                  Toast.show(
                                      "Please add name of your Property.",
                                      context,
                                      duration: 4,
                                      gravity: Toast.TOP);
                                } else {
                                  if (governorate == "") {
                                    ...
                                    if (price.text == "") {
                                      Toast.show(
                                          "Please add Price of your Property.",
                                          context,
                                          duration: 4,
                                          gravity: Toast.TOP);
                                    } else {
  ...
  Future<void> uploadProperty() async {
    ...
    try {
      ...
      Navigator.of(context).pop();
      Toast.show("Property Updated successfully.", context,
      ...
      Navigator.of(context).pop();
      Toast.show("An error occurred. Try again later.", context,
          duration: 4, gravity: Toast.TOP);
    }
  }
